...
import { CriarComentarioOutputDTO } from "../dtos/comment/createComments.dto";
import { DeletarComentarioInputDTO, DeletarComentarioOutputDTO } from "../dtos/comment/deleteComments.dto";
...
export class CommentBusiness {
  ...
  public createComment = async (
  ...
  ): Promise<CriarComentarioOutputDTO> => {
    ...
    const output: CriarComentarioOutputDTO = {
  ...
  public deleteComment = async (
    input: DeletarComentarioInputDTO
  ): Promise<DeletarComentarioOutputDTO> => {
    ...
    const output: DeletarComentarioOutputDTO = {
