...
import { CreatePostInputDTO } from "../dtos/postagem/createPost.dto";
import { DeletePostInputDTO } from "../dtos/postagem/deletePost.dto";
import { BuscarPostInputDTO, BuscarPostOutputDTO } from "../dtos/postagem/getPost.dto";
import { LikeOrDislikePostInputDTO } from "../dtos/postagem/likeOrDislikePost.dto";
...
export class PostBusiness {
  ...
  public getPosts = async (
    input: BuscarPostInputDTO
  ): Promise<BuscarPostOutputDTO> => {
    const { token } = input;
    ...
    const output: BuscarPostOutputDTO = posts;
